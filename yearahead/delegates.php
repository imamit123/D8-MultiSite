...
<head>
    ...
    <title>CIO Year Ahead 2018 | Delegates</title>
...
<style>
.notattending {display:none !important;}
</style>
		...
		<div class="header-class">
			<div class="sidebar hidden-sm-up float-left">
				...
				<div class="list-group" style="display: none;">
					...
					<a href="http://www.cio.in/yearahead/delegates.php?ModPagespeed=off" class="list-group-item">DELEGATES 2017</a>
...
<?php if($k[4]==0){
						...
						$class='attending'; } ?>
				<figure id="<?php echo $id;?>" class='<?php echo $class;?>'>
				<a id="<?php echo $id;?>" href="#"><a>
					<img src="http://www.cio.in/yearahead/images/delegates/<?php echo $name;?>.jpg?id=<?php echo time();?>" alt="<?php echo $name;?>" width="300" height="225"/>
			  <figcaption>
