...
return array(
	'#markup' =>$this->t('<form class="form-search" method="get" action="/g_search"><input type="text" name="q" value="" placeholder="Google search" class="google_search_text" /> <input class="search" type="submit" value="ok" /> </form>'),
	);
   }
}
