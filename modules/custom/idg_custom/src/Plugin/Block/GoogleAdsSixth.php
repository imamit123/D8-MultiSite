...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsSixth.
 */
 ...
 * @Block(
 *   id = "google_ads_sixth",
 *   admin_label = @Translation("Google Ads Sixth"),
 * )
 */
class GoogleAdsSixth extends BlockBase {
