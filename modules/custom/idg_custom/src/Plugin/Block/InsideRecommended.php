...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\InsideRecommended.
 */
 ...
 * @Block(
 *   id = "inside_recommended",
 *   admin_label = @Translation("Inside Recommended"),
 * )
 */
class InsideRecommended extends BlockBase {
