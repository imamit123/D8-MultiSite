...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsFirst.
 */
 ...
 * @Block(
 *   id = "google_ads_first",
 *   admin_label = @Translation("Google Ads First."),
 *   category = @Translation("Custom block")
 * )
 */
class GoogleAdsFirst extends BlockBase {
  ...
  public function build() {
    ...
    if (isset($node)){
     ...
     /* elseif ($node_type == 'partner_content'){
        $string = 'partner_tabsection';
      }
      elseif ($node_type == 'partner_tab'){
        $string = 'partner_tabsection';
      }
      elseif ($node->hasField('field_partner_tab_reference')){
