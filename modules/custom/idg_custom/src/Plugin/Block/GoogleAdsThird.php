...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsThird.
 */
 ...
 * @Block(
 *   id = "google_ads_third",
 *   admin_label = @Translation("Google Ads Third"),
 * )
 */
class GoogleAdsThird extends BlockBase {
