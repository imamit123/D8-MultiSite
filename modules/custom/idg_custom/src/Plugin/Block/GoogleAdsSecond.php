...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsSecond.
 */
 ...
 * @Block(
 *   id = "google_ads_second",
 *   admin_label = @Translation("Google Ads Second"),
 * )
 */
class GoogleAdsSecond extends BlockBase {
