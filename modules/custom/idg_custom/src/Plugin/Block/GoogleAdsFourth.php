...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsFourth.
 */
 ...
 * @Block(
 *   id = "google_ads_fourth",
 *   admin_label = @Translation("Google Ads Fourth"),
 * )
 */
class GoogleAdsFourth extends BlockBase {
