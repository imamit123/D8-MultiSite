...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsFront.
 */
 ...
 * @Block(
 *   id = "google_ads_front",
 *   admin_label = @Translation("Google Ads front"),
 * )
 */
class GoogleAdsFront extends BlockBase {
