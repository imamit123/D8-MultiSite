...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsEighth.
 */
 ...
 * @Block(
 *   id = "google_ads_eighth",
 *   admin_label = @Translation("Google Ads Eighth"),
 * )
 */
class GoogleAdsEighth extends BlockBase {
