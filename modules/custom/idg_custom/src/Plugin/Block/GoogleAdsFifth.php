...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsFifth.
 */
 ...
 * @Block(
 *   id = "google_ads_fifth",
 *   admin_label = @Translation("Google Ads Fifth"),
 * )
 */
class GoogleAdsFifth extends BlockBase {
