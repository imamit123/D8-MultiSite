...
/**
 * @file
 * Contains \Drupal\idg_custom\Plugin\Block\GoogleAdsSeventh.
 */
 ...
 * @Block(
 *   id = "google_ads_seventh",
 *   admin_label = @Translation("Google Ads Seventh"),
 * )
 */
class GoogleAdsSeventh extends BlockBase {
