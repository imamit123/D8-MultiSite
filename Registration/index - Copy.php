        ...
        <div id="tfheader">
            ...
            <div id="tfheader1">
                ...
                <form id="tfnewsearch1" method="get" >
                    <div class="ui-widget">
                        <p><label for="tags">Reference<span>:</span> </label><input type="text" id="add-reference"   onkeyup="search(this.value);" class="tftextinput3" name="searchreference" size="21" maxlength="120" value="" required="" placeholder="Add Reference"></p>
                        ...
                        <select id="add-type" class="tftextinput3" name='type'><?php
...
<input type="radio"  id="radio1" class="" name="radio1" value="Visiting Card" ><label for="radio1">Visiting Card</label>
                       <input type="radio" id="radio2" class="" name="radio1" value="Filled Form" ><label for="radio2"> Filled Form</label>
                      <input type="radio" id="radio3" class="" name="radio1" value="Nothing" ><label for="radio3">Nothing</label>                    </div>
                </form>
                <div class="tfclear"></div>
...
<div id="big-text-div">
            ...
            <form name="sub-form" class="sub-form" action="">
                <label class="register"><input class="checkbox12" name="chkbox" id="chkbox" type="checkbox"  value="1">Register</label><br>
...
<input id="btn3" class="button2" type="button" value="Refresh" onclick="window.location = 'index.php';">
		     <input id="btn4" class="button2" type="button" value="Print" onclick="window.location = 'label_printing.php';">
            </form>
        </div>
    </body>
</html>