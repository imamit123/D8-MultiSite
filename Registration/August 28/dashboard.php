                    ...
                    $('#tfheader').on('click', '.button1', function () {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $('#a3').html("<p><label>Name<span>:</span> </label><span class='hide-span' style='display: inline-flex; width: 300px;' >" + data['first_name'] + " " + data['last_name'] + "</span><input class='edit-contact-info' name='name' style='display:none;' type='text' value='" + data['first_name'] + " " + data['last_name'] + "' /></p>");
                    ...
                    $('#save').click(function () {
                        ...
                        $.ajax({
                            ...
                            success: function (output) {
                                ...
                                $('#a3').html("<p><label>Name<span>:</span> </label><span class='hide-span' style='display: inline-flex; width: 300px;' >" + output['first_name'] + " " + output['last_name'] + "</span><input class='edit-contact-info' name='name' style='display:none;' type='text' value='" + name + "' /></p>");
