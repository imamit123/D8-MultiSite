...
<head>
    ...
    <title>Premier 100 2018| View By Person</title>
    ...
    <div id="wrapper" class="viewbyperson">
        ...
        <ul id="list-content">
            <li class="alphanav-header-A">
				...
				<a class="" href="<?php echo $baseurl;?>/delegates.php/#<?php echo $rows[$i][0]; ?>" onclick="window.location.hash='#<?php echo $rows[$i][0]; ?>';window.location.reload(true);">
