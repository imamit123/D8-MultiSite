...
(function ($) {
    ...
    $pc.fn.extend({
        ...
        createThumb: function (ele) {
			...
			if(count<=2)
				{
					$('.pika-imgnav .previous,.pika-textnav .previous ').hide();
						$('.pika-imgnav .next,.pika-textnav .next').show();
				}
				else
				{		$('.pika-imgnav .previous,.pika-textnav .previous ').show();
						$('.pika-imgnav .next,.pika-textnav .next').show();
				}
            self.hide();
		...
		var exists_class = $('li.jcarousel-item-1').hasClass("active");
	
				if (exists_class) {
					$('.pika-textnav a.previous').css('display','none');
					$('.pika-imgnav a.previous').hide()
				} else {
					if(count<tot)
					{
					$('.pika-textnav a.previous').css('display','block');
					$('.pika-imgnav a.previous').show()
					}}
        },
        ...
        nextClick: function (e) {
            ...
            if (next.length === 0) {
				//next = self.list.find('img:last');
			   //alert("Next button is hided");
            }
				...
				if(count+1>=tot)
					{
						...
						$('.pika-imgnav .previous,.pika-textnav .previous ').show();
			  			$('.pika-imgnav .next,.pika-textnav .next').hide();
